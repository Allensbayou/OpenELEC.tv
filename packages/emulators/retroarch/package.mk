...
PKG_DEPENDS_TARGET="toolchain alsa-lib freetype zlib retroarch-assets core-info retroarch-joypad-autoconfig common-shaders libretro-database ffmpeg bluez-tools"
...
elif [ "$OPENGLES" == "bcm2835-firmware" ]; then
