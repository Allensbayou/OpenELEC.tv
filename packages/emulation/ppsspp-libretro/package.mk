...
PKG_URL="http://sources.lakka.tv/ppsspp-$PKG_VERSION.tar.xz"
...
unpack() {
  tar -Jxf $SOURCES/$PKG_NAME/ppsspp-$PKG_VERSION.tar.xz -C $BUILD
  mv $BUILD/ppsspp-$PKG_VERSION $BUILD/$PKG_NAME-$PKG_VERSION
}
...
make_target() {
  ...
  if [ "$OPENGLES" == "bcm2835-firmware" ]; then
